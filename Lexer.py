...
class Lexer:
    KEYWORDS = re.compile(r"\b(SELECT|FROM|WHERE|INSERT|INTO|VALUES|UPDATE|SET|DELETE|DROP|TABLE|CREATE|PRIMARY|KEY|FOREIGN|AS|IN|LIKE|RENAME|MERGE)\b", re.IGNORECASE)
